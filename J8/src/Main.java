...
//      System.out.println("Right: " + right + ", CurrentSum: " + currentSum);
//
//      // Check if the current window's sum is greater than or equal to the target
//      while (currentSum >= target) {
//        int currentLength = right - left + 1;
//        System.out.println("Window Found - Left: " + left + ", Right: " + right + ", Length: " + currentLength);
//
...
//        System.out.println("Shrinking Window - New Left: " + (left + 1) + ", CurrentSum After Shrink: " + currentSum);
//        left++;
//      }
//    }
//
